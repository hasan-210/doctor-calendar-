    ...
    <form action="{{ route('appointments.update',$appointment->id) }}" method="POST">
        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>startDateTime:</strong>
		            <input type="datetime-local" name="startDateTime" value="{{ $appointment->startDateTime }}" class="form-control" >
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>endDateTime:</strong>
		            <input type="datetime-local" name="endDateTime" value="{{ $appointment->endDateTime }}" class="form-control" >
		        </div>
		    </div>
